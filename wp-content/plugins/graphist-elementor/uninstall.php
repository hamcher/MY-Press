...
use Merkulove\GraphistElementor\Unity\Cache;
use Merkulove\GraphistElementor\Unity\Helper;
use Merkulove\GraphistElementor\Unity\Plugin;
use Merkulove\GraphistElementor\UninstallHelper;
use Merkulove\GraphistElementor\Unity\EnvatoItem;
...
final class Uninstall {
    ...
    private function remove_settings() {
        ...
        foreach ( wp_load_alloptions() as $option => $value ) {
            if ( strpos( $option, 'mdp_graphist_elementor' ) === 0 ) {
                $settings[] = $option;
            }
        }
    ...
    public function get_uninstall_mode() {
        ...
        if ( isset( $uninstall_settings[ 'mdp_graphist_elementor_uninstall_settings' ] ) && $uninstall_settings[ 'mdp_graphist_elementor_uninstall_settings' ] ) { // Default value.
            $uninstall_settings = [
