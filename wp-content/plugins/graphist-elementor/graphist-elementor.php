 ...
 *
 * @wordpress-plugin
 * Plugin Name: Graphist for Elementor
 * Plugin URI: https://1.envato.market/graphist-elementor
 * Description: Creates modern and stylish Elementor widgets to display awesome charts and graphs.
 * Version: 1.2.1
 ...
 * Text Domain: graphist-elementor
...
use Merkulove\GraphistElementor\Caster;
use Merkulove\GraphistElementor\Config;
use Merkulove\GraphistElementor\Unity\Unity;
 ...
 *
 **/
final class GraphistElementor {

    /**
     * The one true GraphistElementor.
     *
     * @var GraphistElementor
     * @since 1.0.0
     * @access private
     **/
	...
	public static function on_activation() {
        ...
        /** Call Graphist on plugin activation */
...
register_activation_hook( __FILE__, [ GraphistElementor::class, 'on_activation' ] );

/** Run 'on_deactivation' when the plugin is deactivated. */
register_deactivation_hook( __FILE__, [ GraphistElementor::class, 'on_deactivation' ] );

/** Run Plugin class once after activated plugins have loaded. */
add_action( 'plugins_loaded', [ GraphistElementor::get_instance(), 'setup' ] );
