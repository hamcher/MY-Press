...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let mdpGraphistElementor = window.mdpGraphistElementor;
        ...
        $checkUpdatesBtn.on( 'click', function ( e ) {
            ...
            let data = {
                ...
                nonce: mdpGraphistElementor.nonce,
                checkUpdates: true
            };

            /** Do AJAX request. */
            $.post( mdpGraphistElementor.ajaxURL, data, function( response ) {
