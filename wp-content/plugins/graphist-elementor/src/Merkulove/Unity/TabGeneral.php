...
final class TabGeneral extends Tab {
	...
	public function add_settings( $tab_slug ) {
        ...
        $group = 'GraphistElementor' . $tab_slug . 'OptionsGroup';
        $section = 'mdp_graphist_elementor_' . $tab_slug . '_page_status_section';
    ...
    private function prepare_attr( $key, $tab_slug, $field ) {
        ...
        $name = 'mdp_graphist_elementor_' . $tab_slug . '_settings';
