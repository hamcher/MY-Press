...
final class TabUpdates extends Tab {
	...
	public function add_settings() {
		...
		$group = 'GraphistElementor' . self::TAB_SLUG . 'OptionsGroup';
		$section = 'mdp_graphist_elementor_' . self::TAB_SLUG . '_page_status_section';

        /** Check for Updates button. */
        add_settings_field( 'check_updates', esc_html__( 'Check for updates:', 'graphist-elementor' ), [ $this, 'check_updates' ], $group, $section );

        /** Check SSL */
        add_settings_field( 'check_ssl', esc_html__( 'SSL verification:', 'graphist-elementor' ), [ $this, 'check_ssl' ], $group, $section );
    ...
    public function check_updates() {
        ...
        UI::get_instance()->render_button(
            esc_html__( 'Clear cache', 'graphist-elementor' ),
            '',
            'autorenew',
            [
                "name" => 'mdp_graphist_elementor_' . self::TAB_SLUG . '_settings' . "[check_updates]",
                "id" => "mdp-updates-btn",
    ...
    public function check_ssl() {
        ...
        UI::get_instance()->render_switcher(
            ...
            esc_html__( 'SSL verification', 'graphist-elementor' ),
            esc_html__( 'Enable to activate the SSL check when receiving updates', 'graphist-elementor' ),
            [
                "name" => 'mdp_graphist_elementor_' . self::TAB_SLUG . '_settings' . "[check_ssl]",
            ]
    ...
    public static function ajax_check_updates() {
        ...
        check_ajax_referer( 'graphist-elementor', 'nonce' );
