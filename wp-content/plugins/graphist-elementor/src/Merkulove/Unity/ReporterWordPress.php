...
final class ReporterWordPress {
	...
	public function get_title() {
        ...
        return esc_html__( 'WordPress Environment', 'graphist-elementor' );
	...
	public function get_fields() {
		...
		return [
			'version'               => esc_html__( 'Version', 'graphist-elementor' ),
			'site_url'              => esc_html__( 'Site URL', 'graphist-elementor' ),
			'home_url'              => esc_html__( 'Home URL', 'graphist-elementor' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'graphist-elementor' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'graphist-elementor' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'graphist-elementor' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'graphist-elementor' ),
			'language'              => esc_html__( 'Language', 'graphist-elementor' ),
			'timezone'              => esc_html__( 'Timezone', 'graphist-elementor' ),
			'admin_email'           => esc_html__( 'Admin Email', 'graphist-elementor' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'graphist-elementor' ),
		];
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.', 'graphist-elementor' );
	...
	public function get_is_multisite() {
		...
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'graphist-elementor' ) : esc_html__( 'No', 'graphist-elementor' )
		];
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'graphist-elementor' );
		}
	...
	public function get_debug_mode() {
		...
		return [
			'value' => WP_DEBUG ? esc_html__( 'Active', 'graphist-elementor' ) : esc_html__( 'Inactive', 'graphist-elementor' )
		];
