...
final class TabAssignments extends Tab  {
	...
	public function add_admin_scripts() {
        ...
        wp_enqueue_script( 'mdp-graphist-elementor-assignments', Plugin::get_url() . 'src/Merkulove/Unity/assets/js/assignments' . Plugin::get_suffix() . '.js', [ 'jquery-datetimepicker-full', 'jquery' ], Plugin::get_version(), true );
	...
	public function render_assignments() {
        ...
        <input type='hidden'
               id="mdp-assignInput"
               name='<?php esc_attr_e( 'mdp_graphist_elementor_' . self::TAB_SLUG . '_settings' ); ?>[assignments]'
        ...
        <div id="mdp-assign-box">
            ...
            <div class="mdp-all-fields">
                ...
                <div class="mdp-panel mdp-panel-box mdp-matching-method mdp-margin <?php $this->is_need_to_hide( 'matching_method' ); ?>">
                    <h4><?php esc_html_e( 'Matching Method', 'graphist-elementor' ); ?></h4>
                    <p><?php esc_html_e( 'Should all or any assignments be matched?', 'graphist-elementor' ); ?></p>
                    <div class="mdp-button-group mdp-button-group mdp-matchingMethod" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-all mdp-active"><?php esc_html_e( 'ALL', 'graphist-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-any"><?php esc_html_e( 'ANY', 'graphist-elementor' ); ?></button>
                    </div>
	                <p><?php esc_html_e('The plugin is enabled on the page if ALL the selected rules matched, or if ANY of the selected rules matched', 'graphist-elementor' ); ?></p>
                </div>

                <div class="mdp-panel mdp-panel-box mdp-wp-content mdp-margin <?php $this->is_need_to_hide( 'wordpress_content' ); ?>">

                    <h4><?php esc_html_e( 'WordPress Content', 'graphist-elementor' ); ?></h4>

                    <div class="mdp-button-group mdp-button-group" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-primary mdp-button-small mdp-ignore mdp-active"><?php esc_html_e( 'Ignore', 'graphist-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-include"><?php esc_html_e( 'Include', 'graphist-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-danger mdp-button-small mdp-exclude"><?php esc_html_e( 'Exclude', 'graphist-elementor' ); ?></button>
                    </div>

                    <div class="mdp-wp-content-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Select on what page types or categories the assignment should be active.', 'graphist-elementor' ); ?>
                        </p>
                        <label>
                ...
                <div class="mdp-panel mdp-panel-box mdp-home-page mdp-margin <?php $this->is_need_to_hide( 'home_page' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Home Page', 'graphist-elementor' ); ?></h4>
                ...
                <div class="mdp-panel mdp-panel-box mdp-menu-items mdp-margin <?php $this->is_need_to_hide( 'menu_items' ); ?>">
                    <h4><?php esc_html_e( 'Menu Items', 'graphist-elementor' ); ?></h4>
                    <div class="mdp-button-group mdp-button-group" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-primary mdp-button-small mdp-ignore mdp-active"><?php esc_html_e( 'Ignore', 'graphist-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-include"><?php esc_html_e( 'Include', 'graphist-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-danger mdp-button-small mdp-exclude"><?php esc_html_e( 'Exclude', 'graphist-elementor' ); ?></button>
                    ...
                    <div class="mdp-menuitems-selection">
                        <p class="mdp-margin-bottom-remove mdp-margin-top"><?php esc_html_e( 'Select the menu items to assign to.', 'graphist-elementor' ); ?></p>
                        <label>
                ...
                <div class="mdp-panel mdp-panel-box mdp-date-time mdp-margin <?php $this->is_need_to_hide( 'date_time' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Date & Time', 'graphist-elementor' ); ?></h4>
                    ...
                    <div class="mdp-period-picker-box">
                        ...
                        <p>
							<?php esc_html_e( 'The date and time assignments use the date/time of your servers, not that of the visitors system.', 'graphist-elementor' ); ?>
                            <br>
							<?php esc_html_e( 'Current date/time:', 'graphist-elementor' ); ?>
                ...
                <div class="mdp-panel mdp-panel-box mdp-languages mdp-margin <?php $this->is_need_to_hide( 'languages' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Languages', 'graphist-elementor' ); ?></h4>
                    ...
                    <div class="languages-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the languages to assign to.', 'graphist-elementor' ); ?></p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-user-roles mdp-margin <?php $this->is_need_to_hide( 'user_roles' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'User Roles', 'graphist-elementor' ); ?></h4>
                    ...
                    <div class="user-roles-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the user roles to assign to.', 'graphist-elementor' ); ?></p>
                        <label>
                ...
                <div class="mdp-panel mdp-panel-box mdp-url mdp-margin <?php $this->is_need_to_hide( 'url' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'URL', 'graphist-elementor' ); ?></h4>
                    ...
                    <div class="mdp-url-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Enter (part of) the URLs to match.', 'graphist-elementor' ); ?><br>
							<?php esc_html_e( 'Use a new line for each different match.', 'graphist-elementor' ); ?>
                        </p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-devices mdp-margin <?php $this->is_need_to_hide( 'devices' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Devices', 'graphist-elementor' ); ?></h4>
                    ...
                    <div class="mdp-devices-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the devices to assign to. Keep in mind that device detection is not always 100% accurate. Users can setup their device to mimic other devices.', 'graphist-elementor' ); ?></p>
                        <label>
                        <select class="devices chosen-select" multiple="">
                            <option value=""></option>
                            <option value="desktop"><?php esc_html_e( 'Desktop', 'graphist-elementor' ); ?></option>
                            <option value="tablet"><?php esc_html_e( 'Tablet', 'graphist-elementor' ); ?></option>
                            <option value="mobile"><?php esc_html_e( 'Mobile', 'graphist-elementor' ); ?></option>
                        </select>
                        </label>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-os mdp-margin <?php $this->is_need_to_hide( 'operating_systems' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Operating Systems', 'graphist-elementor' ); ?></h4>
                    ...
                    <div class="mdp-os-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the operating systems to assign to. Keep in mind that operating system detection is not always 100% accurate. Users can setup their browser to mimic other operating systems.', 'graphist-elementor' ); ?></p>
                        <!--suppress HtmlFormInputWithoutLabel -->
                        <select class="os chosen-select" multiple="">
                            <option value=""></option>
                            <option value="Windows"><?php esc_html_e( 'Windows (All)', 'graphist-elementor' ); ?></option>
                            <option value="Windows nt 10.0"><?php esc_html_e( 'Windows 10', 'graphist-elementor' ); ?></option>
                            <option value="Windows nt 6.2"><?php esc_html_e( 'Windows 8', 'graphist-elementor' ); ?></option>
                            <option value="Windows nt 6.1"><?php esc_html_e( 'Windows 7', 'graphist-elementor' ); ?></option>
                            <option value="Windows nt 6.0"><?php esc_html_e( 'Windows Vista', 'graphist-elementor' ); ?></option>
                            <option value="Windows nt 5.2"><?php esc_html_e( 'Windows Server 2003', 'graphist-elementor' ); ?></option>
                            <option value="Windows nt 5.1"><?php esc_html_e( 'Windows XP', 'graphist-elementor' ); ?></option>
                            <option value="Windows nt 5.01"><?php esc_html_e( 'Windows 2000 sp1', 'graphist-elementor' ); ?></option>
                            <option value="Windows nt 5.0"><?php esc_html_e( 'Windows 2000', 'graphist-elementor' ); ?></option>
                            <option value="Windows nt 4.0"><?php esc_html_e( 'Windows NT 4.0', 'graphist-elementor' ); ?></option>
                            <option value="Win 9x 4.9"><?php esc_html_e( 'Windows Me', 'graphist-elementor' ); ?></option>
                            <option value="Windows 98"><?php esc_html_e( 'Windows 98', 'graphist-elementor' ); ?></option>
                            <option value="Windows 95"><?php esc_html_e( 'Windows 95', 'graphist-elementor' ); ?></option>
                            <option value="Windows ce"><?php esc_html_e( 'Windows CE', 'graphist-elementor' ); ?></option>
                            <option value="#(Mac OS|Mac_PowerPC|Macintosh)#"><?php esc_html_e( 'Mac OS (All)', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X"><?php esc_html_e( 'Mac OSX (All)', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X 10.11"><?php esc_html_e( 'Mac OSX El Capitan', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X 10.10"><?php esc_html_e( 'Mac OSX Yosemite', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X 10.9"><?php esc_html_e( 'Mac OSX Mavericks', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X 10.8"><?php esc_html_e( 'Mac OSX Mountain Lion', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X 10.7"><?php esc_html_e( 'Mac OSX Lion', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X 10.6"><?php esc_html_e( 'Mac OSX Snow Leopard', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X 10.5"><?php esc_html_e( 'Mac OSX Leopard', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X 10.4"><?php esc_html_e( 'Mac OSX Tiger', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X 10.3"><?php esc_html_e( 'Mac OSX Panther', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X 10.2"><?php esc_html_e( 'Mac OSX Jaguar', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X 10.1"><?php esc_html_e( 'Mac OSX Puma', 'graphist-elementor' ); ?></option>
                            <option value="Mac OS X 10.0"><?php esc_html_e( 'Mac OSX Cheetah', 'graphist-elementor' ); ?></option>
                            <option value="#(Mac_PowerPC|Macintosh)#"><?php esc_html_e( 'Mac OS (classic)', 'graphist-elementor' ); ?></option>
                            <option value="#(Linux|X11)#"><?php esc_html_e( 'Linux', 'graphist-elementor' ); ?></option>
                            <option value="OpenBSD"><?php esc_html_e( 'Open BSD', 'graphist-elementor' ); ?></option>
                            <option value="SunOS"><?php esc_html_e( 'Sun OS', 'graphist-elementor' ); ?></option>
                            <option value="QNX"><?php esc_html_e( 'QNX', 'graphist-elementor' ); ?></option>
                            <option value="BeOS"><?php esc_html_e( 'BeOS', 'graphist-elementor' ); ?></option>
                            <option value="OS/2"><?php esc_html_e( 'OS/2', 'graphist-elementor' ); ?></option>
                        </select>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-browsers mdp-margin <?php $this->is_need_to_hide( 'browsers' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Browsers', 'graphist-elementor' ); ?></h4>
                    ...
                    <div class="mdp-browsers-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the browsers to assign to. Keep in mind that browser detection is not always 100% accurate. Users can setup their browser to mimic other browsers.', 'graphist-elementor' ); ?></p>

                        <div class="mdp-widget-manager-control-box">
                            <p><?php esc_html_e( 'Browsers:', 'graphist-elementor' ); ?></p>
                            <div>
                                <!--suppress HtmlFormInputWithoutLabel -->
                                <select class="browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="Chrome"><?php esc_html_e( 'Chrome (All)', 'graphist-elementor' ); ?></option>
                                    <option value="#Chrome/(6[1-9]|70)\.#"><?php esc_html_e( 'Chrome 61-70', 'graphist-elementor' ); ?></option>
                                    <option value="#Chrome/(5[1-9]|60)\.#"><?php esc_html_e( 'Chrome 51-60', 'graphist-elementor' ); ?></option>
                                    <option value="#Chrome/(4[1-9]|50)\.#"><?php esc_html_e( 'Chrome 41-50', 'graphist-elementor' ); ?></option>
                                    <option value="#Chrome/(3[1-9]|40)\.#"><?php esc_html_e( 'Chrome 31-40', 'graphist-elementor' ); ?></option>
                                    <option value="#Chrome/(2[1-9]|30)\.#"><?php esc_html_e( 'Chrome 21-30', 'graphist-elementor' ); ?></option>
                                    <option value="#Chrome/(1[1-9]|20)\.#"><?php esc_html_e( 'Chrome 11-20', 'graphist-elementor' ); ?></option>
                                    <option value="#Chrome/([1-9]|10)\.#"><?php esc_html_e( 'Chrome 1-10', 'graphist-elementor' ); ?></option>
                                    <option value="Firefox"><?php esc_html_e( 'Firefox (All)', 'graphist-elementor' ); ?></option>
                                    <option value="#Firefox/(6[1-9]|70)\.#"><?php esc_html_e( 'Firefox 61-70', 'graphist-elementor' ); ?></option>
                                    <option value="#Firefox/(5[1-9]|60)\.#"><?php esc_html_e( 'Firefox 51-60', 'graphist-elementor' ); ?></option>
                                    <option value="#Firefox/(4[1-9]|50)\.#"><?php esc_html_e( 'Firefox 41-50', 'graphist-elementor' ); ?></option>
                                    <option value="#Firefox/(3[1-9]|40)\.#"><?php esc_html_e( 'Firefox 31-40', 'graphist-elementor' ); ?></option>
                                    <option value="#Firefox/(2[1-9]|30)\.#"><?php esc_html_e( 'Firefox 21-30', 'graphist-elementor' ); ?></option>
                                    <option value="#Firefox/(1[1-9]|20)\.#"><?php esc_html_e( 'Firefox 11-20', 'graphist-elementor' ); ?></option>
                                    <option value="#Firefox/([1-9]|10)\.#"><?php esc_html_e( 'Firefox 1-10', 'graphist-elementor' ); ?></option>
                                    <option value="MSIE"><?php esc_html_e( 'Internet Explorer (All)', 'graphist-elementor' ); ?></option>
                                    <option value="MSIE Edge"><?php esc_html_e( 'Internet Explorer Edge', 'graphist-elementor' ); ?></option>
                                    <option value="Edge/15"><?php esc_html_e( 'Edge 15', 'graphist-elementor' ); ?></option>
                                    <option value="Edge/14"><?php esc_html_e( 'Edge 14', 'graphist-elementor' ); ?></option>
                                    <option value="Edge/13"><?php esc_html_e( 'Edge 13', 'graphist-elementor' ); ?></option>
                                    <option value="Edge/12"><?php esc_html_e( 'Edge 12', 'graphist-elementor' ); ?></option>
                                    <option value="MSIE 11"><?php esc_html_e( 'Internet Explorer 11', 'graphist-elementor' ); ?></option>
                                    <option value="MSIE 10.6"><?php esc_html_e( 'Internet Explorer 10.6', 'graphist-elementor' ); ?></option>
                                    <option value="MSIE 10.0"><?php esc_html_e( 'Internet Explorer 10.0', 'graphist-elementor' ); ?></option>
                                    <option value="MSIE 10."><?php esc_html_e( 'Internet Explorer 10', 'graphist-elementor' ); ?></option>
                                    <option value="MSIE 9."><?php esc_html_e( 'Internet Explorer 9', 'graphist-elementor' ); ?></option>
                                    <option value="MSIE 8."><?php esc_html_e( 'Internet Explorer 8', 'graphist-elementor' ); ?></option>
                                    <option value="MSIE 7."><?php esc_html_e( 'Internet Explorer 7', 'graphist-elementor' ); ?></option>
                                    <option value="#MSIE [1-6]\.#"><?php esc_html_e( 'Internet Explorer 1-6', 'graphist-elementor' ); ?></option>
                                    <option value="Opera"><?php esc_html_e( 'Opera (All)', 'graphist-elementor' ); ?></option>
                                    <option value="#Opera/(5[1-9]|60)\.#"><?php esc_html_e( 'Opera 51-60', 'graphist-elementor' ); ?></option>
                                    <option value="#Opera/(4[1-9]|50)\.#"><?php esc_html_e( 'Opera 41-50', 'graphist-elementor' ); ?></option>
                                    <option value="#Opera/(3[1-9]|40)\.#"><?php esc_html_e( 'Opera 31-40', 'graphist-elementor' ); ?></option>
                                    <option value="#Opera/(2[1-9]|30)\.#"><?php esc_html_e( 'Opera 21-30', 'graphist-elementor' ); ?></option>
                                    <option value="#Opera/(1[1-9]|20)\.#"><?php esc_html_e( 'Opera 11-20', 'graphist-elementor' ); ?></option>
                                    <option value="#Opera/([1-9]|10)\.#"><?php esc_html_e( 'Opera 1-10', 'graphist-elementor' ); ?></option>
                                    <option value="Safari"><?php esc_html_e( 'Safari (All)', 'graphist-elementor' ); ?></option>
                                    <option value="#Version/11\..*Safari/#"><?php esc_html_e( 'Safari 11', 'graphist-elementor' ); ?></option>
                                    <option value="#Version/10\..*Safari/#"><?php esc_html_e( 'Safari 10', 'graphist-elementor' ); ?></option>
                                    <option value="#Version/9\..*Safari/#"><?php esc_html_e( 'Safari 9', 'graphist-elementor' ); ?></option>
                                    <option value="#Version/8\..*Safari/#"><?php esc_html_e( 'Safari 8', 'graphist-elementor' ); ?></option>
                                    <option value="#Version/7\..*Safari/#"><?php esc_html_e( 'Safari 7', 'graphist-elementor' ); ?></option>
                                    <option value="#Version/6\..*Safari/#"><?php esc_html_e( 'Safari 6', 'graphist-elementor' ); ?></option>
                                    <option value="#Version/5\..*Safari/#"><?php esc_html_e( 'Safari 5', 'graphist-elementor' ); ?></option>
                                    <option value="#Version/4\..*Safari/#"><?php esc_html_e( 'Safari 4', 'graphist-elementor' ); ?></option>
                                    <option value="#Version/[1-3]\..*Safari/#"><?php esc_html_e( 'Safari 1-3', 'graphist-elementor' ); ?></option>
                                </select>
                            </div>
                        </div>

                        <div class="mdp-widget-manager-control-box">
                            <p><?php esc_html_e( 'Mobile Browsers:', 'graphist-elementor' ); ?></p>
                            <div>
                                <!--suppress HtmlFormInputWithoutLabel -->
                                <select class="mobile-browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="mobile"><?php esc_html_e( 'All', 'graphist-elementor' ); ?></option>
                                    <option value="Android"><?php esc_html_e( 'Android', 'graphist-elementor' ); ?></option>
                                    <option value="#Android.*Chrome#"><?php esc_html_e( 'Android Chrome', 'graphist-elementor' ); ?></option>
                                    <option value="Blackberry"><?php esc_html_e( 'Blackberry', 'graphist-elementor' ); ?></option>
                                    <option value="IEMobile"><?php esc_html_e( 'IE Mobile', 'graphist-elementor' ); ?></option>
                                    <option value="iPad"><?php esc_html_e( 'iPad', 'graphist-elementor' ); ?></option>
                                    <option value="iPhone"><?php esc_html_e( 'iPhone', 'graphist-elementor' ); ?></option>
                                    <option value="iPod"><?php esc_html_e( 'iPod Touch', 'graphist-elementor' ); ?></option>
                                    <option value="NetFront"><?php esc_html_e( 'NetFront', 'graphist-elementor' ); ?></option>
                                    <option value="NokiaBrowser"><?php esc_html_e( 'Nokia', 'graphist-elementor' ); ?></option>
                                    <option value="Opera Mini"><?php esc_html_e( 'Opera Mini', 'graphist-elementor' ); ?></option>
                                    <option value="Opera Mobi"><?php esc_html_e( 'Opera Mobile', 'graphist-elementor' ); ?></option>
                                    <option value="UC Browser"><?php esc_html_e( 'UC Browser', 'graphist-elementor' ); ?></option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-ips mdp-margin <?php $this->is_need_to_hide( 'ip_addresses' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'IP Addresses', 'graphist-elementor' ); ?></h4>
                    ...
                    <div class="mdp-ips-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
                            <?php esc_html_e( 'IP Addresses / Ranges', 'graphist-elementor' ); ?><br>
                        </p>

                        <!--suppress HtmlFormInputWithoutLabel -->
                        <textarea class="mdp-ips-field"></textarea>
                        <p>
                            <?php esc_html_e( 'List of IP addresses or IP ranges. Example: ', 'graphist-elementor' ); ?><br>
                            <?php esc_html_e( '46.33.233.31', 'graphist-elementor' ); ?><br>
                            <?php esc_html_e( '46.0-46.1', 'graphist-elementor' ); ?><br>
                            <?php esc_html_e( '46', 'graphist-elementor' ); ?>
                        </p>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-php mdp-margin <?php $this->is_need_to_hide( 'custom_php' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Custom PHP', 'graphist-elementor' ); ?></h4>
                    ...
                    <div class="mdp-php-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Enter a piece of PHP code to evaluate. The code must return the value true or false.', 'graphist-elementor' ); ?>
                            <br>
							<?php esc_html_e( 'For instance:', 'graphist-elementor' ); ?>
                        </p>
