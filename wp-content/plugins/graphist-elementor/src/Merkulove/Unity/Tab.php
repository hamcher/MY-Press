...
abstract class Tab {
    ...
    protected function do_settings_base( $tab_slug = null ) {
        ...
        settings_fields( 'GraphistElementor' . $tab_slug . 'OptionsGroup' );
        do_settings_sections( 'GraphistElementor' . $tab_slug. 'OptionsGroup' );
    ...
    protected function add_settings_base( $tab_slug = null ) {
        ...
        /** Status Tab. */
        register_setting( 'GraphistElementor' . $tab_slug . 'OptionsGroup', 'mdp_graphist_elementor_' . $tab_slug . '_settings' );
        add_settings_section( 'mdp_graphist_elementor_' . $tab_slug . '_page_status_section', '', null, 'GraphistElementor' . $tab_slug . 'OptionsGroup' );
