...
final class Plugin {
    ...
    private function initialization() {
        ...
        /** Full path to main plugin file. */
        self::$plugin_file = dirname( dirname( dirname( __DIR__ ) ) ) . '/graphist-elementor.php';
        ...
        if ( in_array( self::$type, [ 'elementor', 'wpbakery' ] ) ) {
            ...
            self::$menu_bases[] = 'elementor_page_mdp_graphist_elementor_settings';
            self::$menu_bases[] = 'settings_page_mdp_graphist_elementor_settings';

        /** For general WordPress plugins. */
        } else {

            self::$menu_bases[] = 'toplevel_page_mdp_graphist_elementor_settings';
            self::$menu_bases[] = 'graphist_elementor_page_mdp_graphist_elementor_settings';
    ...
    private function add_general_tab() {
        ...
        self::$tabs['general'] = [
            ...
            'label'         => esc_html__( 'General', 'graphist-elementor' ),
            'title'         => esc_html__( 'General Settings', 'graphist-elementor' ),
            'show_title'    => true,
            'icon'          => 'tune',
            'fields'        => []
        ];
    ...
    private function add_custom_css_tab() {
        ...
        self::$tabs['custom_css'] = [
            ...
            'label'         => esc_html__( 'Custom CSS', 'graphist-elementor' ),
            'title'         => esc_html__( 'Custom CSS', 'graphist-elementor' ),
            'show_title'    => true,
            'icon'          => 'code',
            'fields'        => [
                'custom_css' => [
                    'type'              => 'css_editor',
                    'description'       => esc_html__( 'Add custom CSS here.', 'graphist-elementor' ),
    ...
    private function add_assignments_tab() {
        ...
        self::$tabs['assignments'] = [
            ...
            'label'         => esc_html__( 'Assignments', 'graphist-elementor' ),
            'title'         => esc_html__( 'Assignments Settings', 'graphist-elementor' ),
            'show_title'    => true,
            'icon'          => 'flag',
            'assignments'   => [
    ...
    private function add_activation_tab() {
        ...
        self::$tabs['activation'] = [
            ...
            'label'         => esc_html__( 'Activation', 'graphist-elementor' ),
            'title'         => esc_html__( 'Plugin Activation', 'graphist-elementor' ),
            'show_title'    => false,
            'icon'          => 'vpn_key',
            'fields'        => [
    ...
    private function add_status_tab() {
        ...
        self::$tabs['status'] = [
            ...
            'label'         => esc_html__( 'Status', 'graphist-elementor' ),
            'title'         => esc_html__( 'System Status', 'graphist-elementor' ),
            'show_title'    => true,
            'icon'          => 'info',
            'reports'       => [
                'server'    => [
    ...
    private function add_updates_tab() {
        ...
        self::$tabs['updates'] = [
            ...
            'label'         => esc_html__( 'Updates', 'graphist-elementor' ),
            'title'         => esc_html__( 'Updates', 'graphist-elementor' ),
            'show_title'    => true,
            'icon'          => 'update',
            'fields'        => [
                'check_ssl' => [
    ...
    private function add_uninstall_tab() {
        ...
        self::$tabs['uninstall'] = [
            ...
            'label'         => esc_html__( 'Uninstall', 'graphist-elementor' ),
            'title'         => esc_html__( 'Uninstall Settings', 'graphist-elementor' ),
            'show_title'    => true,
            'icon'          => 'delete_sweep',
            'fields'        => [
                'delete_plugin' => [
                    'type'              => 'select',
                    'options'           => [
                        'plugin'                => esc_html__( 'Delete plugin only', 'graphist-elementor' ),
                        'plugin+settings'       => esc_html__( 'Delete plugin and settings', 'graphist-elementor' ),
                        'plugin+settings+data'  => esc_html__( 'Delete plugin, settings and data', 'graphist-elementor' ),
                    ],
                    'default'           => 'plugin',
                ]
            ]
    ...
    public static function get_plugin_file() {
        ...
        return dirname( dirname( dirname( __DIR__ ) ) ) . '/graphist-elementor.php';
