 ...
 **/
class bipolar_line_elementor extends Widget_Base {
    ...
    public function __construct( $data = [], $args = null ) {
       ...
       false
        ...
        wp_register_script(
            'mdp-graphist-bipolar-line',
            UnityPlugin::get_url() . 'js/bipolar.line' . UnityPlugin::get_suffix() . '.js',
            [],
            UnityPlugin::get_version(),
            false
        );
        ...
        wp_register_script(
            'mdp-graphist-bipolar-line-popup',
            UnityPlugin::get_url() . 'js/bipolar.line.popup' . UnityPlugin::get_suffix() . '.js',
            [],
            UnityPlugin::get_version(),
            false
        );
    ...
    public function get_name() {
        return 'mdp-graphist-bipolar-line';
    }
    ...
    public function get_title() {
        return esc_html__( 'Bipolar Line Chart', 'graphist-elementor' );
    }
    ...
    public function get_icon() {
        return 'mdp-bipolar-line-elementor-widget-icon';
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'bipolar', 'line', 'graphist', 'chartist' ];
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Bi-polar Line Chart', 'graphist-elementor' ),
                'default'               => esc_html__( 'Bi-polar Line Chart', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'You can also only draw the area shapes of the line chart. Area shapes will always be constructed around their areaBase (that can be configured in the options) which also allows you to draw nice bi-polar areas.', 'graphist-elementor' ),
                'default'               => esc_html__( 'You can also only draw the area shapes of the line chart. Area shapes will always be constructed around their areaBase (that can be configured in the options) which also allows you to draw nice bi-polar areas.', 'graphist-elementor' ),
        ...
        $this->add_control(
            'line_smoothing',
            [
                'label' => esc_html__( 'Smoothing', 'graphist-elementor' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 10,
                'step' => 1,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'center',
                'selectors' => [
                    '{{WRAPPER}} .mdp-bipoline-header-align' => 'text-align: {{title_text_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition' => ['show_title' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-bipoline-header-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition' => ['show_title' => 'yes']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'Justify',
                'selectors' => [
                    '{{WRAPPER}} .mdp-bipoline-description-align' => 'text-align: {{description_text_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition'  => ['show_description' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-bipoline-description-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition'  => ['show_description' => 'yes']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .mdp-bipoline-conventions-align' => 'text-align: {{conventions_title_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition' => ['dots_graph_legend' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-bipoline-conventions-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition' => ['dots_graph_legend' => 'yes']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .mdp-bipoline-conventions-list-align' => 'text-align: {{conventions_style_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition' => ['dots_graph_legend' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-bipoline-conventions-list-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition' => ['dots_graph_legend' => 'yes']
            ]
        );
    ...
    public function get_graphConventions( $settings ) {
        ...
        /** The array stores all the lines that need to be plotted. */
        $lines_html = '<ul class="mdp-typography-list mdp-bipoline-conventions-list-align '.
                      'mdp-bipoline-conventions-list-margin" style="color: %s;">';
    ...
    public function get_app_title( $settings ){
        if( $settings['show_title'] === 'yes' ){
            $title_html = '<h3 class="mdp-typography-title mdp-shadow-title mdp-bipoline-header-align '.
                          'mdp-bipoline-header-margin" style="color: %s;">%s</h3>';
            echo sprintf(
                $title_html,
    ...
    public function get_app_description( $settings ){
        $description_html = '<p class="mdp-typography-description mdp-bipoline-description-align '.
                            'mdp-bipoline-description-margin" style="color: %s;">%s</p>';
        return sprintf(
            $description_html,
    ...
    public function get_app_title_legend( $settings ){
        $title_legend_html = '<h4 class="mdp-typography-legend mdp-shadow-legend mdp-bipoline-conventions-align '.
                             'mdp-bipoline-conventions-margin" style="color: %s;">%s</h4>';
        return sprintf(
            $title_legend_html,
    ...
    protected function render() {
        ...
        foreach ( $Items as $lines => $line){

            if( $max_val_lines < max($line) ){ $max_val_lines = max($line); }

            if( $min_val_lines > min($line) ){ $min_val_lines = min($line); }
        ...
        if( $settings['show_description'] === 'yes' &&
            $settings['after_title'] === 'yes' ){
            echo $this->get_app_description(  $settings );
        }
        ...
        $script_default = "<script>ready( () => { ".
            "window.BipolarLine( '%s', '%s', '%s', [%s], '%s', %s, %s, '%s', '%s', '%s', '%s', '%s', %s ); ".
            "});</script>";

        $script_popup = "<script>ready( () => { ".
            "window.BipolarLinePopup( '%s', '%s', [%s], '%s', %s, %s, '%s', '%s', '%s', '%s', '%s', %s ); ".
            "});</script>";
        ...
        $print_script = sprintf(
            ...
            esc_attr($max_val_lines),
            esc_attr($min_val_lines),
