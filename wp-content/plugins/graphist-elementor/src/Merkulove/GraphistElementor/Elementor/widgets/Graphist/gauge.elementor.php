 ...
 **/
class gauge_elementor extends Widget_Base {
    ...
    public function __construct( $data = [], $args = null ) {
       ...
       false
        ...
        wp_register_script(
            'mdp-graphist-gauge',
            UnityPlugin::get_url() . 'js/gauge' . UnityPlugin::get_suffix() . '.js',
            [],
            UnityPlugin::get_version(),
            false
        );
        ...
        wp_register_script(
            'mdp-graphist-gauge-popup',
            UnityPlugin::get_url() . 'js/gauge.popup' . UnityPlugin::get_suffix() . '.js',
            [],
            UnityPlugin::get_version(),
            false
        );
    ...
    public function get_title() {
        return esc_html__( 'Gauge Chart', 'graphist-elementor' );
    }
    ...
    public function get_icon() {
        return 'mdp-gauge-elementor-widget-icon';
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'gauge', 'graphist', 'chartist' ];
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Gauge Chart', 'graphist-elementor' ),
                'default'               => esc_html__( 'Gauge Chart', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'This pie chart uses total.', 'graphist-elementor' ),
                'default'               => esc_html__( 'This pie chart uses total.', 'graphist-elementor' ),
        ...
        $repeater->add_control(
            'style_lab',
            [
                'label' => esc_html__( 'Label style', 'graphist-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'graphist-elementor' ),
                'label_off' => esc_html__( 'No', 'graphist-elementor' ),
                'return_value' => 'yes',
        ...
        $repeater->add_responsive_control(
            'fontsize_lab',
            [
                'label' => esc_html__( 'Labels font size', 'graphist-elementor' ),
        ...
        $repeater->add_control(
            'lab_color',
            [
                'label' => esc_html__( 'Label color', 'graphist-elementor' ),
                'type' => Controls_Manager::COLOR,
                'scheme' => [
                    'type' => Color::get_type(),
                    'value' => Color::COLOR_1,
        ...
        $repeater->add_control(
            'label_family',
            [
                'label' => esc_html__( 'Labels font', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show convention results as a percentage', 'graphist-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'graphist-elementor' ),
                'label_off' => esc_html__( 'Hide', 'graphist-elementor' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'show_label',
            [
                'label' => esc_html__( 'Show labels', 'graphist-elementor' ),
                'separator'=> 'before',
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'graphist-elementor' ),
                'label_off' => esc_html__( 'Hide', 'graphist-elementor' ),
        ...
        $this->add_control(
            'outside_chart',
            [
                'label' => esc_html__( 'Outside the chart', 'graphist-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'graphist-elementor' ),
                'label_off' => esc_html__( 'Hide', 'graphist-elementor' ),
                'return_value' => 'true',
        ...
        $this->add_control(
            'label_offset',
            [
                'label' => esc_html__( 'Label offset', 'graphist-elementor' ),
                'type' => Controls_Manager::NUMBER,
                'default' => 100,
        ...
        $this->add_control(
            'show_labels_number',
            [
                'label' => esc_html__( 'Show results in numbers', 'graphist-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'graphist-elementor' ),
                'label_off' => esc_html__( 'Hide', 'graphist-elementor' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'value_unit',
            [
                'label' => esc_html__( 'Unit of measurement', 'graphist-elementor' ),
                'type'  => Controls_Manager::TEXT,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show labels results as a percentage', 'graphist-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'graphist-elementor' ),
                'label_off' => esc_html__( 'Hide', 'graphist-elementor' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'donut_options',
            [
                'label' => esc_html__( 'Donut settings', 'graphist-elementor' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            'donut_width',
            [
                'label' => esc_html__( 'Donut width', 'graphist-elementor' ),
                'type' => Controls_Manager::NUMBER,
        ...
        $this->add_control(
            'gauge_options',
            [
                'label' => esc_html__( 'Gauge settings', 'graphist-elementor' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'start_angle',
            [
                'label' => esc_html__( 'Start angle', 'graphist-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            'total_angle',
            [
                'label' => esc_html__( 'Total', 'graphist-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ '%' ],
                'range' => [
                    '%' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'center',
                'selectors' => [
                    '{{WRAPPER}} .mdp-gauge-header-align' => 'text-align: {{title_text_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition' => ['show_title' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-gauge-header-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition' => ['show_title' => 'yes']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'Justify',
                'selectors' => [
                    '{{WRAPPER}} .mdp-gauge-description-align' => 'text-align: {{description_text_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition'  => ['show_description' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-gauge-description-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition'  => ['show_description' => 'yes']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .mdp-gauge-conventions-align' => 'text-align: {{conventions_title_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition' => ['dots_graph_legend' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-gauge-conventions-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition' => ['dots_graph_legend' => 'yes']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .mdp-gauge-conventions-list-align' => 'text-align: {{conventions_style_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition' => ['dots_graph_legend' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-gauge-conventions-list-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition' => ['dots_graph_legend' => 'yes']
            ]
        );
        ...
        foreach ($valueList as $val){
            ...
            if( $val['style_lab'] === 'yes' ) {
                $res .= sprintf(
                    ...
                    esc_attr( $globalClass ),
                    esc_attr( $i ),
                    esc_attr( $val[ 'fontsize_lab' ][ 'size' ] ),
                ...
                $res .= sprintf(
                    ...
                    esc_attr( $globalClass ),
                    esc_attr( $i ),
                    esc_attr( $val[ 'fontsize_lab_tablet' ][ 'size' ] ),
                    esc_attr( $val[ 'fontsize_lab' ][ 'unit' ] )
                );
                ...
                $res .= sprintf(
                    ...
                    esc_attr( $globalClass ),
                    esc_attr( $i ),
                    esc_attr( $val[ 'fontsize_lab_mobile' ][ 'size' ] ),
                    esc_attr( $val[ 'fontsize_lab' ][ 'unit' ] )
                );
    ...
    public function get_graphConventions( $settings, $sumItems, $unit, $statusResults ) {
        ...
        $lines_html = '<ul class="mdp-typography-list mdp-gauge-conventions-list-align '.
                      'mdp-gauge-conventions-list-margin" style="color: %s;">';
    ...
    public function get_app_title( $settings ){
        if( $settings['show_title'] === 'yes' ){
            $title_html = '<h3 class="mdp-typography-title mdp-shadow-title mdp-gauge-header-align '.
                          'mdp-gauge-header-margin" style="color: %s;">%s</h3>';
    ...
    public function get_app_description( $settings ){
        $description_html = '<p class="mdp-typography-description mdp-gauge-description-align '.
                            'mdp-gauge-description-margin" style="color: %s;">%s</p>';
        return sprintf(
            $description_html,
    ...
    public function get_app_title_legend( $settings ){
        $title_legend_html = '<h4 class="mdp-typography-legend mdp-shadow-legend mdp-gauge-conventions-align '.
                             'mdp-gauge-conventions-margin" style="color: %s;">%s</h4>';
        return sprintf(
            $title_legend_html,
    ...
    public function get_app_conventions( $settings, $sumItems, $statusResults ){
        if ( $settings['dots_graph_legend'] === 'yes' ){
            echo sprintf(
                ...
                wp_kses_post( $this->get_graphConventions( $settings, $sumItems, $settings['value_unit'], $statusResults ) )
            );
        }
    }
    ...
    protected function render() {
        ...
        $speed_animation = $settings['speed_animation'];
        ...
        foreach ( $Labels as $key => $val ){
            ...
            if( $settings['show_labels_number'] === 'yes' &&
                ...
                "'%s %s %s'",
                        esc_html($val),
                        esc_html($Items[$key]),
                        esc_html($settings['value_unit'])
                );
            }elseif ( $settings['show_labels_percentage'] === 'yes' ){
                $arrayLabels[] = sprintf(
                 "'%s %s&#37; %s'",
                        esc_html($val),
                        esc_html(round( (( (float) $Items[$key] / (float) $sumItems ) * 100) , 1 )),
                        esc_html($settings['value_unit'])
                );
            }else{
                $arrayLabels[] = "'" . $val . "'";
        ...
        $show_donut = !empty($settings['donut_width']) ? $settings['donut_width'] : 80;

        /** Start angle and total to draw a gauge chart. */
        /** Start angle to draw a gauge chart. */
        $startAngle = !empty($settings['start_angle']['size']) ? $settings['start_angle']['size'] : 0;
        /** Total angle to draw a gauge chart. */
        $total      = !empty($settings['total_angle']['size']) ? 100 + $settings['total_angle']['size'] : 0;
        ...
        $script_default = "<script>ready( () => { ".
            "window.Gauge( '%s', \"%s\", [%s], '%s', %s, %s, '%s', '%s', '%s', '%s', '%s', '%s', '%s', %s ); ".
            "});</script>";

        $script_popup = "<script>ready( () => { ".
            "window.GaugePopup( \"%s\", [%s], '%s', %s, %s, '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', %s ); ".
            "});</script>";
        ...
        $width_tablet = !empty( $settings['donut_width_tablet'] ) ? $settings['donut_width_tablet'] : 70;
        $width_mobile = !empty( $settings['donut_width_mobile'] ) ? $settings['donut_width_mobile'] : 50;
