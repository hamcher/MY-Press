 ...
 **/
class multiline_bar_elementor extends Widget_Base {
    ...
    false
        ...
        wp_register_script(
            'mdp-graphist-multiline-bar',
            UnityPlugin::get_url() . 'js/multiline.bar' . UnityPlugin::get_suffix() . '.js',
            [],
            UnityPlugin::get_version(),
            false
        );
        ...
        wp_register_script(
            'mdp-graphist-multiline-bar-popup',
            UnityPlugin::get_url() . 'js/multiline.bar.popup' . UnityPlugin::get_suffix() . '.js',
            [],
            UnityPlugin::get_version(),
            false
        );
    ...
    public function get_name() {
        return 'mdp-graphist-multiline-bar';
    }
    ...
    public function get_title() {
        return esc_html__( 'Multiline Bar Chart', 'graphist-elementor' );
    }
    ...
    public function get_icon() {
        return 'mdp-multiline-bar-elementor-widget-icon';
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'multiline', 'bar', 'graphist', 'chartist' ];
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Multiline Bar Chart', 'graphist-elementor' ),
                'default'               => esc_html__( 'Multiline Bar Chart', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Multiple Vertical Bar Chart', 'graphist-elementor' ),
                'default'               => esc_html__( 'Multiple Vertical Bar Chart', 'graphist-elementor' ),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'center',
                'selectors' => [
                    '{{WRAPPER}} .mdp-multiline-header-align' => 'text-align: {{title_text_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition' => ['show_title' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-multiline-header-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition' => ['show_title' => 'yes']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'Justify',
                'selectors' => [
                    '{{WRAPPER}} .mdp-multiline-description-align' => 'text-align: {{description_text_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition'  => ['show_description' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-multiline-description-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition'  => ['show_description' => 'yes']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .mdp-multiline-conventions-align' => 'text-align: {{conventions_title_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition' => ['dots_graph_legend' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-multiline-conventions-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition' => ['dots_graph_legend' => 'yes']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .mdp-multiline-conventions-list-align' => 'text-align: {{conventions_style_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition' => ['dots_graph_legend' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-multiline-conventions-list-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition' => ['dots_graph_legend' => 'yes']
            ]
        );
     ...
     * @return array
     */
    public function get_arrayBars( $settings ) {
    ...
    public function get_barColor( $settings, $globalClass ) {
        ...
        for ( $i = 1; $i <= $number_lines; $i++ ) {
            ...
            $res .= sprintf(
        '.%s > svg > g > .ct-series-%s > .ct-bar{ stroke: %s !important; stroke-width: %spx !important; }',
    ...
    public function get_graphConventions( $settings ) {
        ...
        /** The array stores all the lines that need to be plotted. */
        $lines_html = '<ul class="mdp-typography-list mdp-multiline-conventions-list-align '.
                      'mdp-multiline-conventions-list-margin" style="color: %s;">';
    ...
    public function get_app_title( $settings ){
        if( $settings['show_title'] === 'yes' ){
            $title_html = '<h3 class="mdp-typography-title mdp-shadow-title mdp-multiline-header-align '.
                          'mdp-multiline-header-margin" style="color: %s;">%s</h3>';
    ...
    public function get_app_description( $settings ){
        $description_html = '<p class="mdp-typography-description mdp-multiline-description-align '.
                            'mdp-multiline-description-margin" style="color: %s;">%s</p>';
        return sprintf(
            $description_html,
    ...
    public function get_app_title_legend( $settings ){
        $title_legend_html = '<h4 class="mdp-typography-legend mdp-shadow-legend mdp-multiline-conventions-align '.
                             'mdp-multiline-conventions-margin" style="color: %s;">%s</h4>';
        return sprintf(
            $title_legend_html,
    ...
    protected function render() {
        ...
        $Items = $this->get_arrayBars($settings);
        ...
        $script_default = "<script>ready( () => { ".
            "window.MultilineBar( '%s', '%s', '%s', [%s], %s, '%s', '%s', '%s', '%s', '%s', %s ); ".
            "});</script>";

        $script_popup = "<script>ready( () => { ".
            "window.MultilineBarPopup( '%s', '%s', [%s], %s, '%s', '%s', '%s', '%s', '%s', %s ); ".
            "});</script>";
