...
class pie_elementor extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Pie Chart', 'graphist-elementor' );
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'pie', 'graphist', 'chartist' ];
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Title chart', 'graphist-elementor' ),
                'condition'             => ['show_title' => 'yes'],
                'default'               => esc_html__( 'Pie Chart', 'graphist-elementor' )
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Description chart', 'graphist-elementor' ),
                'condition'             => ['show_description' => 'yes'],
                'default'               => esc_html__( 'A very simple pie chart with label interpolation to show percentage instead of the actual data series value.', 'graphist-elementor' )
            ]
        );
