 ...
 **/
class dots_elementor extends Widget_Base {
    ...
    public function __construct( $data = [], $args = null ) {
        ...
        wp_register_script(
            'mdp-graphist-dots',
            UnityPlugin::get_url() . 'js/dots' . UnityPlugin::get_suffix() . '.js',
            [],
            UnityPlugin::get_version(),
            false
        );
        ...
        wp_register_script(
            'mdp-graphist-dots-popup',
            UnityPlugin::get_url() . 'js/dots.popup' . UnityPlugin::get_suffix() . '.js',
            [],
            UnityPlugin::get_version(),
            false
        );
    ...
    public function get_title() {
        return esc_html__( 'Dots Chart', 'graphist-elementor' );
    }
    ...
    public function get_icon() {
        return 'mdp-dots-elementor-widget-icon';
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'dots', 'graphist', 'chartist' ];
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Dots chart', 'graphist-elementor' ),
                'default'               => esc_html__( 'Dots chart', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'This advanced example uses a line chart to draw a scatter diagram. The data object is created with a functional style random mechanism. ', 'graphist-elementor' ),
                'default'               => esc_html__( 'This advanced example uses a line chart to draw a scatter diagram. The data object is created with a functional style random mechanism. ', 'graphist-elementor' ),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'center',
                'selectors' => [
                    '{{WRAPPER}} .mdp-dots-header-align' => 'text-align: {{title_text_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition' => ['show_title' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-dots-header-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition' => ['show_title' => 'yes']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'Justify',
                'selectors' => [
                    '{{WRAPPER}} .mdp-dots-description-align' => 'text-align: {{description_text_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition'  => ['show_description' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-dots-description-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition'  => ['show_description' => 'yes']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .mdp-dots-conventions-align' => 'text-align: {{conventions_title_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition' => ['dots_graph_legend' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-dots-conventions-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition' => ['dots_graph_legend' => 'yes']
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .mdp-dots-conventions-list-align' => 'text-align: {{conventions_style_align}};',
                ],
                'toggle' => true,
                'label_block' => true,
                'condition' => ['dots_graph_legend' => 'yes']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-dots-conventions-list-margin' => 'margin: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}};',
                ],
                'condition' => ['dots_graph_legend' => 'yes']
            ]
        );
     ...
     * @return array
     */
    public function get_arrayDot( $settings ) {
    ...
    public function get_graphConventions( $settings ) {
        ...
        /** The array stores all the lines that need to be plotted. */
        $lines_html = '<ul class="mdp-typography-list mdp-dots-conventions-list-align '.
                      'mdp-dots-conventions-list-margin" style="color: %s;">';
    ...
    public function get_app_title( $settings ){
        if( $settings['show_title'] === 'yes' ){
            $title_html = '<h3 class="mdp-typography-title mdp-shadow-title mdp-dots-header-align '.
                          'mdp-dots-header-margin" style="color: %s;">%s</h3>';
    ...
    public function get_app_description( $settings ){
        $description_html = '<p class="mdp-typography-description mdp-dots-description-align '.
                            'mdp-dots-description-margin" style="color: %s;">%s</p>';
        return sprintf(
            $description_html,
    ...
    public function get_app_title_legend( $settings ){
        $title_legend_html = '<h4 class="mdp-typography-legend mdp-shadow-legend mdp-dots-conventions-align '.
                             'mdp-dots-conventions-margin" style="color: %s;">%s</h4>';
        return sprintf(
            $title_legend_html,
    ...
    protected function render() {
        ...
        $Items = $this->get_arrayDot( $settings );
        ...
        $script_default = "<script>ready( () => { ".
            "window.Dots( '%s', '%s', '%s', [%s], '%s', '%s', '%s', '%s', '%s', %s ); ".
            "});</script>";

        $script_popup = "<script>ready( () => { ".
            "window.DotsPopup( '%s', '%s', [%s], '%s', '%s', '%s', '%s', '%s', %s ); ".
            "});</script>";
