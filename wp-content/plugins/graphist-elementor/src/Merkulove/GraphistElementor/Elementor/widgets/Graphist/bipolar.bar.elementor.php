...
class bipolar_bar_elementor extends Widget_Base {
    ...
    public function __construct( $data = [], $args = null ) {
       ...
       false
        ...
        wp_register_script(
            'mdp-graphist-bipolar-bar-popup',
    ...
    public function get_name() {
        return 'mdp-graphist-bipolar-bar';
    }
    ...
    public function get_title() {
        return esc_html__( 'Bipolar Bar Chart', 'graphist-elementor' );
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'bipolar', 'bar', 'graphist', 'chartist' ];
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Bi-polar bar char', 'graphist-elementor' ),
                'default'               => esc_html__( 'Bi-polar bar char', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'A bi-polar bar chart with a range limit set with low and high. There is also an interpolation function used to skip every odd grid line / label.', 'graphist-elementor' ),
                'default'               => esc_html__( 'A bi-polar bar chart with a range limit set with low and high. There is also an interpolation function used to skip every odd grid line / label.', 'graphist-elementor' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Item name', 'graphist-elementor' ),
            ]
        );
