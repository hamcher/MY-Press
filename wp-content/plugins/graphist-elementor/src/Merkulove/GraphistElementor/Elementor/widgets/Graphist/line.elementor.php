...
class line_elementor extends Widget_Base {
   ...
   false
    ...
    public function get_title() {
        return esc_html__( 'Line Chart', 'graphist-elementor' );
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'line', 'graphist', 'chartist' ];
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Line Chart', 'graphist-elementor' ),
                'default'               => esc_html__( 'Line Chart', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'An example of a simple line chart with three series. You can edit this example in real time.', 'graphist-elementor' ),
                'default'               => esc_html__( 'An example of a simple line chart with three series. You can edit this example in real time.', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'                  => Controls_Manager::TEXTAREA,
                'dynamic'               => ['active' => true],
                'description'           => esc_html__( 'Default shortcode [line_chart]', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Line animation duration(ms)', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Line animation delay(ms)', 'graphist-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Axis animation duration(ms)', 'graphist-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Axis animation delay(ms)', 'graphist-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
