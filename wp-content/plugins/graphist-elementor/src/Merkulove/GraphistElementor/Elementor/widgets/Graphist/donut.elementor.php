...
class donut_elementor extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Donut Chart', 'graphist-elementor' );
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'donut', 'graphist', 'chartist' ];
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Donut Chart', 'graphist-elementor' ),
                'default'               => esc_html__( 'Donut Chart', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'This pie chart uses donut.', 'graphist-elementor' ),
                'default'               => esc_html__( 'This pie chart uses donut.', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'                  => Controls_Manager::TEXTAREA,
                'dynamic'               => ['active' => true],
                'description'           => esc_html__( 'Default shortcode [donut_chart]', 'graphist-elementor' ),
        ...
        $repeater->add_responsive_control(
            'fontsize_lab',
            [
                'label' => esc_html__( 'Label font size', 'graphist-elementor' ),
        ...
        $repeater->add_control(
            'label_family',
            [
                'label' => esc_html__( 'Label font', 'graphist-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show results as a percentage', 'graphist-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'graphist-elementor' ),
                'label_off' => esc_html__( 'Hide', 'graphist-elementor' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'title_color',
            [
                'label' => esc_html__( 'Сolor', 'graphist-elementor' ),
                'type' =>  Controls_Manager::COLOR,
                'scheme' => [
                    'type' => Color::get_type(),
                    'value' => Color::COLOR_1,
