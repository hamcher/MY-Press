...
* First iteration of thr beta. See


= 6.3.8.0 (September 27th, 2021) =
...
= 6.3.7.9 (September 21st, 2021) =

# Bugs fixed
* Plugin conflict with OxyMade, where Microthemer's color picker did not display properly.

= 6.3.7.8 (September 15th, 2021) =

# Bugs fixed
* XAMPP (running PHP8) issue where the interface was unresponsive and an error displayed - e.tooltip is not a function. This affected non-English translations of Microthemer (e.g. Portuguese). Previously, setting a legacy version of jQuery via MT's preferences was recommended, but this is no longer necessary.

= 6.3.7.7 (September 6th, 2021) =
