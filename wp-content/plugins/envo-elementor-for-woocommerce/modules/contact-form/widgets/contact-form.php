...
namespace ETWWElementor\Modules\ContactForm\Widgets;
...
class Contact_Form extends Widget_Base {
    ...
    public function get_title() {
        return __('Contact Form 7', 'etww');
    }

    public function get_icon() {
        return 'etww-icon eicon-form-horizontal';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
                ...
                [
                    'label' => __('Not Valid Notices', 'etww'),
        ...
        $this->add_control(
                'button_fullwidth',
                [
                    'label' => __('Fullwidth Button', 'etww'),
    ...
    protected function get_available_forms() {
        ...
        if (!etww_is_contact_form_7_active()) {
            return array();
        }
